package com.example.xweatherappx.views;

import com.example.xweatherappx.controller.WeatherService;
...
public class MainView<cityName> extends UI {
    ...
    private NativeSelect<String> cityDropDown;
    ...
    private void setHeader(){
        ...
        Label Title = new Label("weatherX");
        Title.addStyleName(ValoTheme.LABEL_H1);
        Title.addStyleName(ValoTheme.LABEL_BOLD);
        Title.addStyleName(ValoTheme.LABEL_COLORED);
        
        Label subTitle = new Label("Real Time Weather");
        subTitle.addStyleName(ValoTheme.LABEL_H4);
        //subTitle.addStyleName(ValoTheme.LABEL_BOLD);
        //subTitle.addStyleName(ValoTheme.LABEL_COLORED);

        headerlayout.addComponents(Title,subTitle);
    ...
    private void setForm(){
        ...
        searchButton.setCaption("Check Weather");
    ...
    private void dashboardTitle() {
        ...
        //City Location
        location = new Label("Currently in Aurangabad");
    ...
    private void updateUI() throws JSONException {
        ...
        String remainingLetters = city.substring(1, city.length());

        // change the first letter to uppercase
        firstLetter = firstLetter.toUpperCase();

        // join the two substrings
        String cityWithFirstLetterInUpperCase = firstLetter + remainingLetters;
        location.setValue("Currently in "+cityWithFirstLetterInUpperCase);
        ...
        //Updating Feels Like
        feelsLike.setValue("Feelslike: "+weatherService.returnMainObject().getDouble("feels_like")+defaultUnit);
